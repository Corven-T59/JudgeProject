...
class SolutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create solution" do
    assert_difference('Solution.count') do
      post solutions_url, params: { solution: { language: @solution.language, problem_id: @solution.problem_id, solutionFile: @solution.solutionFile, user_id: @solution.user_id } }
    end
  ...
  test "should update solution" do
    patch solution_url(@solution), params: { solution: { language: @solution.language, problem_id: @solution.problem_id, solutionFile: @solution.solutionFile, user_id: @solution.user_id } }
