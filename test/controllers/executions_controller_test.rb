...
class ExecutionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create execution" do
    assert_difference('Execution.count') do
      post executions_url, params: { execution: { runTime: @execution.runTime, solution_id: @execution.solution_id, status: @execution.status, user_id: @execution.user_id } }
    end
  ...
  test "should update execution" do
    patch execution_url(@execution), params: { execution: { runTime: @execution.runTime, solution_id: @execution.solution_id, status: @execution.status, user_id: @execution.user_id } }
